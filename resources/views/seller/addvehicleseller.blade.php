...
@section('content')
                ...
                <main>
                    ...
                    <div
                        ...
                        <h1 class="text-2xl font-semibold">Add My Own Vehicles</h1>
                            ...
                            <div class="col-span-2 bg-white rounded-md dark:bg-darker" x-data="{ isOn: false }">
                                ...
                                <div class=" p-4 border-b dark:border-primary">
                                    ...
                                    <div class=" col-12  ">
                                        ...
                                        <form action="{{ route('seller.store') }}" method="post" enctype="multipart/form-data" class=" col-12 ">
                                            @csrf
                                            ...
                                            <div class="flex col-12 ">
                                                <div class="form-group col-4 m-1">
                                                    ...
                                                    <input type="number" class="form-control"
                                                        id="exampleInputEmail1" name="mileage" placeholder="Mileage">
                                              ...
                                              <div class="flex col-12 ">
                                                <div class="form-group col-4 m-1">
                                                    ...
                                                    <input type="file" multiple class="form-control"
                                                        id="exampleInputEmail1" name="images[]"
                                                        placeholder="Images">
