...
@section('content')
    ...
    <form  method="POST" action="{{ route('register') }}">
        ...
        <div class="members">
            ...
            <div class="choices">
                <div class="member">
                    <div class="memberradio"><input type="radio" name="type_account" value="Business"></div>
                    <img src="/images/business1.png" alt="" srcset="">
                    <p><span>Business</span>Holds business licenses(s)</p>
                </div>
                <div class="member">
                    <div class="memberradio"><input type="radio" name="type_account"value="Individual"></div>
