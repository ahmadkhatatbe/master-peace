            ...
            <div class="mt-2">
              ...
              <div class="grid grid-cols-1 gap-8 p-4 lg:grid-cols-2 xl:grid-cols-4">
                ...
                <div class="flex items-center justify-between p-4 bg-white rounded-md dark:bg-darker">
                  ...
                  @endphp
                    <span class="text-xl font-semibold">{{$seller}}</span>
                ...
                <div class="flex items-center justify-between p-4 bg-white rounded-md dark:bg-darker">
                  <div>
                    ...
                    <span class="text-xl font-semibold">{{count($users)}}</span>
                ...
                <div class="flex items-center justify-between p-4 bg-white rounded-md dark:bg-darker">
                  <div>
                    ...
                    <span class="text-xl font-semibold">{{count($vehicles)}}</span>
                    <span class="inline-block px-2 py-px ml-2 text-xs text-green-500 bg-green-100 rounded-md">
                      +3.1%
                    </span>
                  </div>
                ...
                <div class="flex items-center justify-between p-4 bg-white rounded-md dark:bg-darker">
                  <div>
                    ...
                    <span class="text-xl font-semibold">{{count($auctions)}}</span>
                    <span class="inline-block px-2 py-px ml-2 text-xs text-green-500 bg-green-100 rounded-md">
                      +3.1%
                    </span>
                  </div>
