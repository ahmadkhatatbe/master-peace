...
<head>
    ...
    <title>Mazadi Dashboard</title>
    <link href="{{ url('https://fonts.googleapis.com/css2?family=Cairo:wght@200;300;400;600;700;900&display=swap') }}"
        rel="stylesheet" />
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet"
        integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">
    <link rel="stylesheet" href="/css/dashboard.css" />
    <script
        src="{{ url('https://cdn.jsdelivr.net/gh/alpine-collective/alpine-magic-helpers@0.5.x/dist/component.min.js') }}">
    </script>
    <script src="{{ url('https://cdn.jsdelivr.net/gh/alpinejs/alpine@v2.7.3/dist/alpine.min.js') }}" defer></script>
</head>
                        ...
                        <div x-data="{ isActive: true, open: true }">
                            ...
                            <a href="#" @click="$event.preventDefault(); open = !open"
                                ...
                                <span aria-hidden="true">
                                    <svg class="w-5 h-5" xmlns="{{ url('http://www.w3.org/2000/svg') }}" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                                    </svg>
                                </span>
                                <span class="ml-2 text-sm"> Admins </span>
                            ...
                            <div role="menu" x-show="open" class="mt-2 space-y-2 px-7" aria-label="Dashboards">
                                ...
                                <a href="{{ route('adminhome') }}" role="menuitem"
                                ...
                                <a href="{{ route('vehicle.index') }}" role="menuitem"
  ...
  <a href="{{ route('auction.index') }}" role="menuitem"
                        ...
                        <div x-data="{ isActive: false, open: false }">
                            ...
                            <a href="#" @click="$event.preventDefault(); open = !open"
                                ...
                                <span class="ml-2 text-sm"> Winners </span>
                                <span aria-hidden="true" class="ml-auto">
                                    <!-- active class 'rotate-180' -->
                                    <svg class="w-4 h-4 transition-transform transform" :class="{ 'rotate-180': open }"
                                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
            ...
            <div class="flex-1 h-full overflow-x-hidden overflow-y-auto">
                        ...
                        <nav x-transition:enter="transition duration-200 ease-in-out transform sm:duration-500"
                            ...
                            <div class="relative ml-auto" x-data="{ open: false }">
                                <button @click="open = !open" type="button" aria-haspopup="true"
                                    ...
                                    <span class="sr-only">User menu</span>
                                    <img class="w-10 h-10 rounded-full" src="{{ url('./build/images/cover-2.jpg') }}"
                                        alt="Ahmedkhatatbeh" />
                                </button>
                        ...
                        <nav aria-label="Main" class="px-2 py-4 space-y-2">
                            ...
                            <div x-data="{ isActive: true, open: true }">
                                ...
                                <div role="menu" x-show="open" class="mt-2 space-y-2 px-7"
                                    ...
                                    <a href="{{ route('admins.index') }}" role="menuitem"
                                        class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">
                                        Admins </a>
                ...
                <footer
                    ...
                    <div>Mazadi &copy; 2023</div>
                    <div>
                        Made by
                        <a href="https://github.com/ahmadkhatatbe" target="_blank"
                            class="text-blue-500 hover:underline">Ahmad Khatatbeh</a>
                    </div>
                </footer>
            </div>
                    ...
                    <div class="space-y-4" x-show.transition.in="activeTabe == 'user'">
                        ...
                        <a href="#" class="block">
                            <div class="flex px-4 space-x-4">
                                ...
                                <div class="flex-1 overflow-hidden">
                                    <h5 class="text-sm font-semibold text-gray-600 dark:text-light">Ahmad Khatatbeh
                                    </h5>
                                    <p
                                        class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
                                        Release new version "Mazadi Dashboard"
                                    </p>
                        ...
                        <template x-for="i in 10" x-key="i">
                            <a href="#" class="block">
                                <div class="flex px-4 space-x-4">
                                    ...
                                    <div class="flex-1 overflow-hidden">
                                        <h5 class="text-sm font-semibold text-gray-600 dark:text-light">Ahmad
                                            Khatatbeh</h5>
                                        <p
                                            class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
                                            Release new version "Mazadu Dashboard"
                                        </p>
            ...
            <div class="flex flex-col h-screen">
                ...
                <div class="flex-1 px-4 pb-4 space-y-4 overflow-y-hidden h hover:overflow-y-auto">
                    ...
                    <a href="#" class="flex space-x-4">
                        ...
                        <div class="flex-1 max-w-xs overflow-hidden">
                            <h4 class="text-sm font-semibold text-gray-600 dark:text-light">Ahmad Khatatbeh</h4>
                            <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
                    ...
                    <template x-for="i in 10" x-key="i">
                        <a href="#" class="flex space-x-4">
                            ...
                            <div class="flex-1 max-w-xs overflow-hidden">
                                <h4 class="text-sm font-semibold text-gray-600 dark:text-light">Mazadu Dashboard
                                </h4>
                                <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
                                    Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                                </p>
