   ...
   @section('content')
       ...
       <div class="members">
           ...
           <div class="choices"id="chooseone">
               <div class="member ">
                   <div class="memberradio">
                    <input type="radio" name="typeofbusiness" id="business" value="Business">
                </div>
           ...
           <div class="choices" id="choosetow">
               <div class="member">
                   <div class="memberradio">
                    <input type="radio" id="individual" name="typeofindividual" value="Individual">
                </div>
           ...
           <div class="form">
               <div class="form-main">
                   ...
                   <input id="password" type="password" name="password" required autocomplete="new-password"
                       class="password" placeholder="password"><br>
